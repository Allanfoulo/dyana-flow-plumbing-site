          ...
          <div className="flex flex-col items-center gap-12">
            <div className="w-full">
              <p className="text-lg text-muted-foreground leading-relaxed text-center">
                We provide comprehensive water solutions that ensure your home has clean, safe water and reliable storage for uninterrupted supply. Our expert team specializes in premium Jojo water storage tank installations that guarantee you never run out of water, with durable UV-resistant tanks in various sizes for residential and commercial properties. We also install advanced multi-stage water filtration systems that remove up to 99.9% of harmful contaminants, chlorine, and impurities, transforming your tap water into clean, great-tasting drinking water. Additionally, our state-of-the-art UV water purification systems eliminate 99.99% of bacteria, viruses, and harmful microorganisms without chemicals, providing instant, environmentally-friendly purification. From professional installation to comprehensive warranties and ongoing maintenance, we deliver complete water management solutions that protect your family's health and give you peace of mind during water shortages.
              </p>
            </div>
            <div className="w-full">
            <Carousel
